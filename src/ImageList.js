...
// Need to pass which type element can be draggable, its a simple string or Symbol.
// This is like an Unique ID so that the library know what type of element is dragged or dropped on.
const type = "Image";
